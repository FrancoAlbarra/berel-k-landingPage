...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 flex flex-col md:flex-row gap-40 text-gray-300'>
      <div>
        ...
        <p className='py-1 pb-10'>Nuestro horario de atención es <strong>Lunes</strong> a <strong>viernes</strong> de 8.45 a 18.15 Sábado de 9.45 a 14.15hs. Venite a conocernos cuando quieras!</p>
