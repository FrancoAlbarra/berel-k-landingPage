    ...
    <div className='flex lg:justify-between lg:flex-row flex-col items-center lg:mr-20 lg:ml-20 h-[80px] lg:h-[100px] max-w-[full] mx-auto mb-[170px] lg:pt-[100px] lg:pb-[40px] px-4'>
      ...
      <div className=' flex flex-col items-center'>
        ...
        <div class="inline-flex rounded-md shadow-sm" role="group" >
          <button type="button" onClick={handleDownloadV} class="px-4 py-2 text-[18px] font-medium text-blue bg-blue border border-gray-200 rounded-l-lg hover:bg-gray-100 hover:text-blue-700">
          <FontAwesomeIcon icon={faDownload} className='mr-2'/>
            Catálogo Verano
            <FontAwesomeIcon icon={faUmbrellaBeach} className='ml-2'/>
          </button>
          <button type="button" onClick={handleDownload} class="px-4 py-2 text-[18px] font-medium text-white bg-blue border border-gray-200 rounded-r-md hover:bg-gray-100 hover:text-blue-700">
            <FontAwesomeIcon icon={faDownload} className='mr-2'/>
            Catálogo Invierno
    ...
    <div className='text-white bg-cover bg-no-repeat bg-center' style={{
      ...
      <div className='w-full lg:mt-[-250px] md:mt-[-250px] mt-[-100px] flex flex-col lg:flex-row h-screen justify-center items-center lg:px-[100px] px-[20px]'>
        <div className='w-full md:pt-[350px]  lg:pt-[90px] mx-auto flex flex-col justify-center lg:items-start items-center'>
          ...
          <p className='lg:text-2xl text-[2vh] font-semiBold font-poppins text-white mb-4 text-center md:text-center lg:text-left'>Somos fabricantes de pantuflas y ojotas.<br />Realizamos envíos a todo el país.</p>
        </div>
